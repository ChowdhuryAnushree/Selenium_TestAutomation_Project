from pages import sign_in_success_page
from pages.index_page import IndexPage
from pages.register_page import RegisterPage
from pages.register_success_page import RegisterSuccessPage
from pages.sign_in_success_page import SignInSuccessPage
...
class TestLogin:
    ...
    def test_sign_in(self,driver,username_password):
        ...
        sign_in_page.type_password(username_password)
        sign_in_page.click_submit_btn()

        sign_in_success_page = SignInSuccessPage(driver)
        sign_in_success_lbl = sign_in_success_page.get_register_success_label()
        assert sign_in_success_lbl.__contains__('Thank you for Loggin.'), "User sign-in failed!"

    def test_sign_off(self,driver):
        sign_in_success_page = SignInSuccessPage(driver)
        sign_in_success_page.click_logout_url()